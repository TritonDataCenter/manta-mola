 ...
 *
 * The resulting rows emitted will have the following values:
...
function PgRowTransformer(opts, listener) {
        ...
        self.schema_reader.on('object', function (obj) {
                ...
                if (table === PG_LIVE_MANTA_TABLE_NAME) {
                        row = transformLive(obj, dump_date);
 ...
 */
function transformLive(obj, dump_date) {
 ...
 * [ORIGINAL OBJECT]
 */
function transformDead(obj, least_dump_date) {
